<?php  
  ...
  if (isset($_POST['login_user']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    signInUser($_POST , $checkConds , 'joinedusers' , 'user_email');
  }
                                ...
                                <div class="g-col-2">
                                    ...
                                    <div class="signupform__div">
                                        ...
                                        <div class="inside--singup__div flex-col">
                                            ...
                                            <p class="mian--paragraph mt-1">من خلال تسجيل الدخول على حسابك فانك تقر بالشروط والاحكام الخاصة بالنادي والموقع</p>
                                        </div>
                                        </div>
                                    </div>
                                 ...
                                 <h1 class="headline--main-2"> تسجيل الدخول </h1>
                               
                                 <p class="mian--paragraph-sm mt-1">ليس لديك حساب ؟  <span class="gothought_a">سجل الان </span>   </p>
                                 ...
                                 <form action="" method="POST" class="singup__form">
                                     ...
                                     <div class="signup__form--div">
                                         ...
                                         <input type="text" name="user_email" placeholder="ادخل الاميل الخاص بك" class="singup__input">
                                     </div>
    
                                     <div class="signup__form--div">
                                         <div><label for="" class="singup__label">كلمة المرور </label></div>
                                         <input type="password" name="user_password" placeholder="ادخل كلمة المرور الخاصة بك" class="singup__input" autocomplete="off" >
                                     </div>
                  <input type="submit" name="login_user" value="تسجيل الدخول" class="singup_btn" >
                                 </form>
                                    </div>
